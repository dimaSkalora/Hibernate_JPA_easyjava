package hibernate_test.data_hibernate_pools_13.c3p0;

import hibernate.data_hibernate_pools_13.c3p0.entity.Operation;
...
public class RelationsTest {
    ...
    public void setUp() throws Exception {
        final StandardServiceRegistry registry = new StandardServiceRegistryBuilder()
                .configure("hibernate_resources/data-hibernate-pools_13/c3p0/hibernate.cfg.xml")
                .build();
